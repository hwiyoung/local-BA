...
def orthophoto_lba(image_path, metadata_in_image, sys_cal, flag, types,
                   matching_accuracy=2, diff_init_esti=10, epsg=5186, gsd=0, output_path="."):
    ######################
    ### Georeferencing ###
    ######################
    ### 1. Georeferencing
